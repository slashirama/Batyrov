...
#создаем функцию для опеределения процентной ставки в зависимости от суммы
def interest_rate(summa):
    if summa < 50000:
        procent = 4
    ...
    return procent #возвращаем значение в программу
procent = interest_rate(summa)
